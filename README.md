...
• Implemented a Linked List that uses optimistic synchronisation. 
• Implemented a Linked List that uses lazy synchronisation. 
• Implemented a Bounded Queue that uses optimistic synchronisation. 
